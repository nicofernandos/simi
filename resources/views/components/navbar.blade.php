<nav class="bg-gray-800" x-data="{ isOpen: false }">
      ...
      <div class="flex h-16 items-center justify-between">
        <div class="flex items-center">
          <div class="flex-shrink-0">
            <img class="h-10 w-10 rounded-xl" src="{{ asset('img/imb.jpeg') }}" alt="Your Company">
          </div>
          <div class="hidden md:block">
            <div class="ml-10 flex items-baseline space-x-4">
              ...
              <x-nav-link href="/report" :active="request()->is('report')" >Kelola Absensi</x-nav-link>
              <x-nav-link href="/report" :active="request()->is('report')" >Kelola Karyawan</x-nav-link>
    ...
    <div x-show="isOpen" class="md:hidden" id="mobile-menu">
      <div class="space-y-1 px-2 pb-3 pt-2 sm:px-3">
        <!-- Current: "bg-gray-900 text-white", Default: "text-gray-300 hover:bg-gray-700 hover:text-white" -->
        <x-nav-link href="/" :active="request()->is('/')" >Home</x-nav-link>
        <x-nav-link href="/absent" :active="request()->is('posts')" >Absensi</x-nav-link>
        <x-nav-link href="/report" :active="request()->is('about')" >Laporan Kerja</x-nav-link>
        <x-nav-link href="/logout" :active="request()->is('logout')" >Contact</x-nav-link>
