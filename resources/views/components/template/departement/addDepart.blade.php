        ...
        <div class="min-w-full space-y-3 px-2 py-4">
            <div class="grid grid-cols-2 gap-4">
              <div class="flex rounded-lg shadow-md border-2 border-slate-300">
                <span class="px-4 inline-flex items-center min-w-fit rounded-s-md border-2 border-e-2 border-gray-200 bg-gray-50 text-sm text-gray-600 text-gray-500" hidden>ID</span>
                <input type="text" id="id" name="id" class="py-3 px-4 pe-11 block w-full border-gray-200 shadow-sm rounded-e-lg text-sm text-gray-800 focus:z-10 focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none">
              </div>
              <div class="flex rounded-lg shadow-md border-2 border-slate-300">
                ...
                <input type="text" id="no_id" name="no_id" placeholder="Masukkan nomor id" class="form-control py-3 px-4 pe-11 block w-full border-gray-200 shadow-sm rounded-e-lg text-sm text-gray-800 focus:z-10 focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none">
              </div>
              <div class="flex rounded-lg shadow-md border-2 border-slate-300">
                ...
                <input type="text" id="name" name="name" placeholder="masukkan nama" class="form-control py-3 px-4 pe-11 block w-full border-gray-200 shadow-sm rounded-e-lg text-sm text-gray-800 focus:z-10 focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none">
              </div>
              <div class="flex rounded-lg shadow-md border-2 border-slate-300">
                ...
                <input type="text" id="description" name="description" placeholder="masukkan description" class="form-cotrol py-3 px-4 pe-11 block w-full border-gray-200 shadow-sm rounded-e-lg text-sm text-gray-800 focus:z-10 focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none">
              </div>
            </div>
          </div>
