    ...
    <div class="bg-gray-100 flex-1 p-6 md:mt-16">
        ...
        <div class="overflow-x-auto">
            <div class="mt-4 mb-3 pr-10 text-right ">
                <a href="{{ route('reportPDFMan') }}?start_date={{ $start_date }}&end_date={{ $end_date }}" class="bg-red-500 hover:bg-red-700 text-white font-light font-thin py-2 px-4 rounded rounded-xl"> 
